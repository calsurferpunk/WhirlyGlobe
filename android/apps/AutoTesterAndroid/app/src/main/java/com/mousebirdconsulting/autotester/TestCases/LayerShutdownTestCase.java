...
public class LayerShutdownTestCase extends MaplyTestCase  {
    ...
    private QuadImageTileLayer setupImageLayer(ConfigOptions.TestType testType, MaplyBaseController baseController) {
        ...
        cacheDir.mkdir();
        RemoteTileSource remoteTileSource = new RemoteTileSource(baseController,new RemoteTileInfo("https://tiles.stadiamaps.com/tiles/stamen_terrain_background/{z}/{x}/{y}@2x.png?api_key=" + stamenKey, 0, 18));
